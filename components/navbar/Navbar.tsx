...
const Navbar: React.FC<NavbarProps> = () => {
 ...
 useEffect(() => {
  ...
  gsap.set(userLinksRef.current.querySelectorAll("li"), { x: -50, opacity: 0 });
  ...
  return (
    <div className={styles.navbar}>
      ...
      <ul className={styles.links} ref={linksRef}>
        <li>
          {" "}
          <Link href={"/games"} className={isActiveLink("/games")}>Games</Link>
        </li>
        <li>
        ...
        <li>
          <Link href={"/news"} className={isActiveLink("/news")}>News</Link>
        </li>
        <li>Leaderboard</li>
        <li>Tools</li>
        <li>Teams</li>
